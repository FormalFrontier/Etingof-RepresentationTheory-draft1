...
namespace IntroductionToRepresentationTheoryVerso.Content.Chapter2.Definition273

#doc (Manual) "Faithful representation" =>
...
## Formalization
%%%
tag := "Chapter2/Definition2.7.3/formalization"
number := false
%%%
