...
namespace IntroductionToRepresentationTheoryVerso.Content.Chapter3.Theorem3102

#doc (Manual) "Irreducible representations of tensor products of algebras" =>

# Irreducible representations of tensor products of algebras
%%%
tag := "Chapter3/Theorem3.10.2"
number := false
%%%
