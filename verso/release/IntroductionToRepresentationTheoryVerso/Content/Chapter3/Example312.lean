...
namespace IntroductionToRepresentationTheoryVerso.Content.Chapter3.Example312

#doc (Manual) "End(V) as a semisimple representation" =>
# End(V) as a semisimple representation
%%%
tag := "Chapter3/Example3.1.2"
number := false
%%%
