...
namespace IntroductionToRepresentationTheoryVerso.Content.Chapter3.Theorem362

#doc (Manual) "Linear independence of characters; basis in semisimple case" =>
# Linear independence of characters; basis in semisimple case
%%%
