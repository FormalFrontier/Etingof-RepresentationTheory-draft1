...
namespace IntroductionToRepresentationTheoryVerso.Content.Chapter5.DiscussionAfterProposition523

#doc (Manual) "Notation for algebraic numbers and algebraic integers" =>

# Notation for algebraic numbers and algebraic integers
%%%
tag := "Chapter5/Discussion_after_Proposition5.2.3"
number := false
%%%
