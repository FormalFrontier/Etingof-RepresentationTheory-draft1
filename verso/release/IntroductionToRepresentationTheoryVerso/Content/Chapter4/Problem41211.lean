...
namespace IntroductionToRepresentationTheoryVerso.Content.Chapter4.Problem41211

#doc (Manual) "Application of representation theory to elasticity (Hooke's law)" =>

# Application of representation theory to elasticity (Hooke's law)
%%%
tag := "Chapter4/Problem4.12.11"
number := false
%%%
