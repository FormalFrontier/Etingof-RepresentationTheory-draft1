...
## Formalization
%%%
tag := "Chapter4/Discussion_after_Theorem4.6.2/formalization"
number := false
%%%
...
{Manual.docstring RepresentationTheory.Group.ConjugateDuality.conjugateRepresentation}

{Manual.docstring RepresentationTheory.Group.ConjugateDuality.exists_intertwiningMap_conjugate_dual}
