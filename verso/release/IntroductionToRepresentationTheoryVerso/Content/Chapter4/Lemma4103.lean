...
## Formalization
%%%
tag := "Chapter4/Lemma4.10.3/formalization"
number := false
%%%

### Primary declarations

{Manual.docstring RepresentationTheory.AuxiliaryMatrixDeterminantIrreducibility.det_auxiliaryMatrix_irreducible_of_pos}
