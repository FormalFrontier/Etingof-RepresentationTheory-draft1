...
namespace IntroductionToRepresentationTheoryVerso.Content.Chapter6.Example624

#doc (Manual) "Example 6.2.4: Indecomposable representations of A3" =>

# Example 6.2.4: Indecomposable representations of A3
%%%
tag := "Chapter6/Example6.2.4"
number := false
%%%
