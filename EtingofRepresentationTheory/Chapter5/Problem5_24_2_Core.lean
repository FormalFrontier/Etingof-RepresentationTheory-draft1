...
preserves it. The tensor bridge (`Problem5_24_2_Bridge.lean`) and the final First Fundamental
Theorem assembly (`Problem5_24_2.lean`) build on these definitions.
