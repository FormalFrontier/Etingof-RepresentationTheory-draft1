...
/-! ## The projective cover `Pᵢ = A · eᵢ` -/

variable (k Q) in
/-- **The indecomposable projective cover** `Pᵢ = A · eᵢ` of the path algebra: the principal left
submodule generated by the trivial-path idempotent `eᵢ`. Its inherited `A`-, `k`-module and
scalar-tower instances are found automatically from `Submodule.module'`. Note `PathAlgebra k Q`
