...
theorem Etingof.Theorem_9_2_1_iii
  ...
  -- (This requires Q/N and M j₀ in the same universe. Since Q may be in a different
  -- universe than M : ι → Type uA, we need Q to be in Type uA. The Module k Q
  -- hypothesis was added to support this; in practice all modules are in Type uA.)
  obtain ⟨j₀, ⟨e⟩⟩ := hM_exhaustive (Q ⧸ N)
