...
The simple reflections here are the root-lattice reflections
...
the identity `simpleReflectionDimVector_eq_simpleReflection` relating its
...
The reflections are the root-lattice reflections of Definition 6.4.10
