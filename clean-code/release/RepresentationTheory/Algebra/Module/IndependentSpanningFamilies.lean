...
namespace RepresentationTheory.Algebra.Module.IndependentSpanningFamilies

private lemma exists_iSupIndep_eq_top_aux (k : Type*) (A : Type*) (V : Type*)
  ...
  | succ d ih =>
    ...
    · 
      ...
      · intro i
        ...
        exact this
      · intro i
        have : RepresentationTheory.LinearAlgebra.ModuleDecompositions.AuxiliaryDecompositionPredicate A (W' (finSumFinEquiv.symm i)) :=
...
@[source_ref "Chapter3/Theorem3.8.1" (role := primary),
  source_ref "Chapter3/Theorem3.8.1/Derived3" (role := supporting)]
theorem exists_iSupIndep_eq_top (k : Type*) (A : Type*) (V : Type*)
  ...
  obtain ⟨n, W, _, hindec, hsup, hind⟩ := exists_iSupIndep_eq_top_aux k A V
    (Module.finrank k V) ⊤
...
private lemma exists_equiv_summand (k : Type*) (A : Type*) (V : Type*)
    [Field k] [Ring A] [Algebra k A]
    [AddCommGroup V] [Module k V] [Module A V] [IsScalarTower k A V]
    [FiniteDimensional k V]
...
private lemma eq_card_and_exists_equiv_of_iSupIndep_aux (k : Type*) (A : Type*) [Field k] [Ring A] [Algebra k A]
...
@[source_ref "Chapter3/Discussion_proof_of_Theorem3.8.1" (role := supporting),
  source_ref "Chapter3/Discussion_proof_of_Theorem3.8.1/Derived2" (role := supporting),
  source_ref "Chapter3/Lemma3.8.2/Derived5" (role := supporting),
  source_ref "Chapter3/Theorem3.8.1" (role := primary),
  source_ref "Chapter3/Theorem3.8.1/Derived4" (role := supporting)]
theorem eq_card_and_exists_equiv_of_iSupIndep (k : Type*) (A : Type*) (V : Type*)
  ...
  eq_card_and_exists_equiv_of_iSupIndep_aux k A (Module.finrank k V) V le_rfl
