...
Finite-function models and a classification of finite-dimensional simple modules in prime characteristic.
-/

namespace RepresentationTheory.WeylAlgebra.ModularSimpleModules
...
/-- The derivative-plus-scalar and cyclic position endomorphisms satisfy the Weyl commutation relation. -/
...
theorem exists_nonempty_moduleScalarParameterType [IsAlgClosed k] (V : Type*) [AddCommGroup V] [Module k V]
  ...
  obtain ⟨α, c, b, hbx, hby⟩ := RepresentationTheory.NoncommutativeAlgebra.PositiveCharacteristic.exists_cyclic_basis_of_simpleModule k p V
  refine ⟨α, c, ?_⟩
  letI := modelModule k p α c
  haveI := modelModule_isScalarTower k p α c
...
end RepresentationTheory.WeylAlgebra.ModularSimpleModules

attribute [nolint defsWithUnderscore]
  RepresentationTheory.WeylAlgebra.ModularSimpleModules.cyclicPositionCoeff RepresentationTheory.WeylAlgebra.ModularSimpleModules.cyclicPositionEnd
  RepresentationTheory.WeylAlgebra.ModularSimpleModules.successorCoeff RepresentationTheory.WeylAlgebra.ModularSimpleModules.derivativeAddScalarEnd
  RepresentationTheory.WeylAlgebra.ModularSimpleModules.modelRepresentation RepresentationTheory.WeylAlgebra.ModularSimpleModules.modelModule
  RepresentationTheory.WeylAlgebra.ModularSimpleModules.FourScalarParameterType RepresentationTheory.WeylAlgebra.ModularSimpleModules.ModuleScalarParameterType
  RepresentationTheory.WeylAlgebra.ModularSimpleModules.moduleScalarParameterTypeToLinearEquiv
