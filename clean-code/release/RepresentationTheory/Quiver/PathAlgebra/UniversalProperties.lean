    ...
    _root_.RepresentationTheory.Quiver.PathAlgebra.Quiver.PathAlgebra.ofPath
      ...
      _root_.RepresentationTheory.Quiver.PathAlgebra.Quiver.PathAlgebra.ofPath
          ...
          (⟨a, b, q⟩ :
            _root_.RepresentationTheory.Quiver.PathAlgebra.Quiver.BundledPath Q) *
        arrow k Q e := by
  unfold arrow _root_.RepresentationTheory.Quiver.PathAlgebra.Quiver.PathAlgebra.ofPath
  rw [_root_.RepresentationTheory.Quiver.PathAlgebra.Quiver.PathAlgebra.single_mul_single,
    one_mul, one_smul,
    _root_.RepresentationTheory.Quiver.PathAlgebra.Quiver.PathAlgebra.mulPath_of_composable,
...
theorem vertexArrow_adjoin_eq_top [Fintype Q] :
    Algebra.adjoin k
      ({ x : _root_.RepresentationTheory.Quiver.PathAlgebra.Quiver.PathAlgebra k Q |
          ∃ i, x = vertex k Q i } ∪
        { x : _root_.RepresentationTheory.Quiver.PathAlgebra.Quiver.PathAlgebra k Q |
  ...
  | single x c =>
    ...
    have hsc :
        (Finsupp.single
            (⟨a, b, p⟩ :
              _root_.RepresentationTheory.Quiver.PathAlgebra.Quiver.BundledPath Q) c :
          _root_.RepresentationTheory.Quiver.PathAlgebra.Quiver.PathAlgebra k Q) =
          c •
            _root_.RepresentationTheory.Quiver.PathAlgebra.Quiver.PathAlgebra.ofPath
              (k := k)
              (⟨a, b, p⟩ :
                _root_.RepresentationTheory.Quiver.PathAlgebra.Quiver.BundledPath Q) := by
      exact
        (_root_.RepresentationTheory.Quiver.PathAlgebra.Quiver.PathAlgebra.smul_single_one
          c _).symm
    rw [hsc]
...
theorem sum_vertex_eq_one [Fintype Q] :
  ...
  simp only [vertex]
  exact
    _root_.RepresentationTheory.Quiver.PathAlgebra.Quiver.PathAlgebra.sum_vertexPath_eq_one
      k Q
...
theorem vertex_mul_self [Fintype Q] (i : Q) :
  ...
  unfold vertex _root_.RepresentationTheory.Quiver.PathAlgebra.Quiver.PathAlgebra.ofPath
  rw [_root_.RepresentationTheory.Quiver.PathAlgebra.Quiver.PathAlgebra.single_mul_single,
    _root_.RepresentationTheory.Quiver.PathAlgebra.Quiver.PathAlgebra.mulPath_vertexPath,
...
theorem vertex_mul_vertex_of_ne [Fintype Q] (i j : Q) (h : i ≠ j) :
  ...
  rw [_root_.RepresentationTheory.Quiver.PathAlgebra.Quiver.PathAlgebra.single_mul_single,
    _root_.RepresentationTheory.Quiver.PathAlgebra.Quiver.PathAlgebra.mulPath_vertexPath,
    if_neg h]
  exact _root_.RepresentationTheory.Quiver.PathAlgebra.Quiver.PathAlgebra.smul_zero _
...
theorem arrow_mul_targetVertex [Fintype Q] {i j : Q} (e : i ⟶ j) :
  ...
  unfold arrow vertex
    _root_.RepresentationTheory.Quiver.PathAlgebra.Quiver.PathAlgebra.ofPath
  rw [_root_.RepresentationTheory.Quiver.PathAlgebra.Quiver.PathAlgebra.single_mul_single,
    _root_.RepresentationTheory.Quiver.PathAlgebra.Quiver.PathAlgebra.mulPath_pathVertex,
    if_pos rfl, mul_one, one_smul]
...
noncomputable def oppositeVertex (i : Q) :
    _root_.RepresentationTheory.Quiver.PathAlgebra.Quiver.OppositePathAlgebra k Q :=
  _root_.RepresentationTheory.Quiver.PathAlgebra.Quiver.OppositePathAlgebra.vertexElement
    (k := k) (Q := Q) i

/-- The element of the opposite path algebra associated with a quiver arrow. -/
noncomputable def oppositeArrow {i j : Q} (e : i ⟶ j) :
    _root_.RepresentationTheory.Quiver.PathAlgebra.Quiver.OppositePathAlgebra k Q :=
  _root_.RepresentationTheory.Quiver.PathAlgebra.Quiver.OppositePathAlgebra.opOfPath
    (k := k) ⟨i, j, e.toPath⟩
      ...
      oppositeArrow k Q e *
        _root_.RepresentationTheory.Quiver.PathAlgebra.Quiver.OppositePathAlgebra.opOfPath
          ...
          (⟨a, b, q⟩ :
            _root_.RepresentationTheory.Quiver.PathAlgebra.Quiver.BundledPath Q) := by
  rw [oppositeArrow,
    _root_.RepresentationTheory.Quiver.PathAlgebra.Quiver.OppositePathAlgebra.opOfPath_mul_opOfPath,
    Quiver.Path.comp_toPath_eq_cons]
...
theorem oppositeVertexArrow_adjoin_eq_top [Fintype Q] :
    Algebra.adjoin k
      ({ x : _root_.RepresentationTheory.Quiver.PathAlgebra.Quiver.OppositePathAlgebra k Q |
      ...
      have hsc : MulOpposite.op
        ...
        exact
          (_root_.RepresentationTheory.Quiver.PathAlgebra.Quiver.PathAlgebra.smul_single_one
            c
            (⟨a, b, p⟩ :
              _root_.RepresentationTheory.Quiver.PathAlgebra.Quiver.BundledPath Q)).symm
      have hmem : c •
          _root_.RepresentationTheory.Quiver.PathAlgebra.Quiver.OppositePathAlgebra.opOfPath
              (k := k)
              (⟨a, b, p⟩ :
...
theorem sum_oppositeVertex_eq_one [Fintype Q] :
  ...
  exact
    _root_.RepresentationTheory.Quiver.PathAlgebra.Quiver.OppositePathAlgebra.sum_vertexElement_eq_one
...
theorem oppositeVertex_mul_oppositeVertex_of_ne [Fintype Q] (i j : Q) (h : i ≠ j) :
  ...
  exact
    _root_.RepresentationTheory.Quiver.PathAlgebra.Quiver.OppositePathAlgebra.opOfPath_mul_opOfPath_eq_zero
...
noncomputable def pathLinearMap :
    _root_.RepresentationTheory.Quiver.PathAlgebra.Quiver.PathAlgebra k Q →ₗ[k] B :=
  Finsupp.linearCombination k
    (fun x : _root_.RepresentationTheory.Quiver.PathAlgebra.Quiver.BundledPath Q =>
...
theorem pathLinearMap_single
    (x : _root_.RepresentationTheory.Quiver.PathAlgebra.Quiver.BundledPath Q) (c : k) :
...
theorem existsUnique_pathAlgebraHom [Fintype Q]
    ...
    ∃! φ :
        _root_.RepresentationTheory.Quiver.PathAlgebra.Quiver.PathAlgebra k Q →ₐ[k] B,
  ...
  have h1 : pathLinearMap P A
      (1 : _root_.RepresentationTheory.Quiver.PathAlgebra.Quiver.PathAlgebra k Q) = 1 := by
    rw [_root_.RepresentationTheory.Quiver.PathAlgebra.Quiver.PathAlgebra.one_eq_sum_ofPath_vertexPath,
      map_sum]
    refine Eq.trans (Finset.sum_congr rfl fun i _ => ?_) hsum
    simp [_root_.RepresentationTheory.Quiver.PathAlgebra.Quiver.PathAlgebra.ofPath,
  ...
  have hmul : ∀ x y :
    ...
    | single sx a =>
      ...
      | single sy b =>
        ...
        by_cases hxy : xb = ya
        · subst hxy
          rw [_root_.RepresentationTheory.Quiver.PathAlgebra.Quiver.PathAlgebra.mulPath_of_composable]
          simp only [map_smul, pathLinearMap_single, one_smul]
          rw [hcomp, smul_mul_assoc, mul_smul_comm, smul_smul]
        · rw [_root_.RepresentationTheory.Quiver.PathAlgebra.Quiver.PathAlgebra.mulPath_of_not_composable
  ...
  let φ : _root_.RepresentationTheory.Quiver.PathAlgebra.Quiver.PathAlgebra k Q →ₐ[k] B :=
...
theorem existsUnique_oppositePathAlgebraHom [Fintype Q]
    ...
    ∃! φ :
        _root_.RepresentationTheory.Quiver.PathAlgebra.Quiver.OppositePathAlgebra k Q →ₐ[k] B,
  ...
  intro χ hχ
  let χop :
      _root_.RepresentationTheory.Quiver.PathAlgebra.Quiver.PathAlgebra k Q →ₐ[k] Bᵐᵒᵖ :=
