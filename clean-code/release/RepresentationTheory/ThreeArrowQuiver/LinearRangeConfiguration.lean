...
noncomputable abbrev zeroToSinkLinearMap :=
  @RepresentationTheory.CategoryTheory.QuiverLinearDiagrams.QuiverLinearDiagram.map ℂ (Fin 4) _ RepresentationTheory.Quiver.FinFourLinearData.finFourQuiverA RepresentationTheory.Quiver.FinFourLinearData.finFourDiagramAAlt
    0 3 zeroToSink
...
noncomputable local instance vertexAddCommGroup (v : Fin 4) : AddCommGroup
    (@RepresentationTheory.CategoryTheory.QuiverLinearDiagrams.QuiverLinearDiagram.obj ℂ (Fin 4) _ RepresentationTheory.Quiver.FinFourLinearData.finFourQuiverA RepresentationTheory.Quiver.FinFourLinearData.finFourDiagramAAlt v) :=
...
private theorem centre_finrank : Module.finrank ℂ
    (@RepresentationTheory.CategoryTheory.QuiverLinearDiagrams.QuiverLinearDiagram.obj ℂ (Fin 4) _ RepresentationTheory.Quiver.FinFourLinearData.finFourQuiverA RepresentationTheory.Quiver.FinFourLinearData.finFourDiagramAAlt 3) = 2 := by
  have h := RepresentationTheory.Quiver.FinFourLinearData.finFourDiagramAAlt_finrank_eq 3
  have h' : (Module.finrank ℂ
      (@RepresentationTheory.CategoryTheory.QuiverLinearDiagrams.QuiverLinearDiagram.obj ℂ (Fin 4) _ RepresentationTheory.Quiver.FinFourLinearData.finFourQuiverA RepresentationTheory.Quiver.FinFourLinearData.finFourDiagramAAlt 3) : ℤ) = 2 := by
    simpa using h
  exact_mod_cast h'

private theorem arm_finrank (i : Fin 4) (hi : i ≠ 3) : Module.finrank ℂ
    (@RepresentationTheory.CategoryTheory.QuiverLinearDiagrams.QuiverLinearDiagram.obj ℂ (Fin 4) _ RepresentationTheory.Quiver.FinFourLinearData.finFourQuiverA RepresentationTheory.Quiver.FinFourLinearData.finFourDiagramAAlt i) = 1 := by
...
private theorem armMap_injective {i : Fin 4} (hi : i ≠ 3)
    (e : @Quiver.Hom (Fin 4) RepresentationTheory.Quiver.FinFourLinearData.finFourQuiverA i 3) : Function.Injective
      (@RepresentationTheory.CategoryTheory.QuiverLinearDiagrams.QuiverLinearDiagram.map ℂ (Fin 4) _ RepresentationTheory.Quiver.FinFourLinearData.finFourQuiverA RepresentationTheory.Quiver.FinFourLinearData.finFourDiagramAAlt
        i 3 e) := by
  let A := @RepresentationTheory.CategoryTheory.QuiverLinearDiagrams.QuiverLinearDiagram.map ℂ (Fin 4) _ RepresentationTheory.Quiver.FinFourLinearData.finFourQuiverA
  ...
  have hP : ∀ {a b : Fin 4} (f : @Quiver.Hom (Fin 4) RepresentationTheory.Quiver.FinFourLinearData.finFourQuiverA a b), ∀ x ∈ P a,
    ...
    · have hxzero : x = 0 := by
        have : x ∈ (⊥ : Submodule ℂ
            (@RepresentationTheory.CategoryTheory.QuiverLinearDiagrams.QuiverLinearDiagram.obj ℂ (Fin 4) _ RepresentationTheory.Quiver.FinFourLinearData.finFourQuiverA RepresentationTheory.Quiver.FinFourLinearData.finFourDiagramAAlt a)) := by
          simpa [P, ha] using hx
  ...
  · exfalso
    have htop : (⊤ : Submodule ℂ
        (@RepresentationTheory.CategoryTheory.QuiverLinearDiagrams.QuiverLinearDiagram.obj ℂ (Fin 4) _ RepresentationTheory.Quiver.FinFourLinearData.finFourQuiverA RepresentationTheory.Quiver.FinFourLinearData.finFourDiagramAAlt 3)) = ⊥ := by
      simpa [R, h3i] using hbot 3
    have hrank := congrArg (fun T : Submodule ℂ
        (@RepresentationTheory.CategoryTheory.QuiverLinearDiagrams.QuiverLinearDiagram.obj ℂ (Fin 4) _ RepresentationTheory.Quiver.FinFourLinearData.finFourQuiverA RepresentationTheory.Quiver.FinFourLinearData.finFourDiagramAAlt 3) =>
...
theorem sup_range_eq_top :
  ...
  rcases RepresentationTheory.Quiver.FinFourLinearData.finFourDiagramAAlt_hasProperty.2 P R hP hR hcompl with hbot | hbot
  · have htop : (⊤ : Submodule ℂ
        (@RepresentationTheory.CategoryTheory.QuiverLinearDiagrams.QuiverLinearDiagram.obj ℂ (Fin 4) _ RepresentationTheory.Quiver.FinFourLinearData.finFourQuiverA RepresentationTheory.Quiver.FinFourLinearData.finFourDiagramAAlt 0)) = ⊥ := by
      simpa [P] using hbot 0
    have hrank := congrArg (fun U : Submodule ℂ
        (@RepresentationTheory.CategoryTheory.QuiverLinearDiagrams.QuiverLinearDiagram.obj ℂ (Fin 4) _ RepresentationTheory.Quiver.FinFourLinearData.finFourQuiverA RepresentationTheory.Quiver.FinFourLinearData.finFourDiagramAAlt 0) =>
...
structure AuxiliaryRangeEquivData where
  ...
  sinkEquiv : (@RepresentationTheory.CategoryTheory.QuiverLinearDiagrams.QuiverLinearDiagram.obj ℂ (Fin 4) _ RepresentationTheory.Quiver.FinFourLinearData.finFourQuiverA
  ...
  zeroEquivRange : (@RepresentationTheory.CategoryTheory.QuiverLinearDiagrams.QuiverLinearDiagram.obj ℂ (Fin 4) _ RepresentationTheory.Quiver.FinFourLinearData.finFourQuiverA
  ...
  oneEquivRange : (@RepresentationTheory.CategoryTheory.QuiverLinearDiagrams.QuiverLinearDiagram.obj ℂ (Fin 4) _ RepresentationTheory.Quiver.FinFourLinearData.finFourQuiverA
  ...
  twoEquivRange : (@RepresentationTheory.CategoryTheory.QuiverLinearDiagrams.QuiverLinearDiagram.obj ℂ (Fin 4) _ RepresentationTheory.Quiver.FinFourLinearData.finFourQuiverA
...
theorem finrank_ranges_and_sup_eq_top :
    Module.finrank ℂ (@RepresentationTheory.CategoryTheory.QuiverLinearDiagrams.QuiverLinearDiagram.obj ℂ (Fin 4) _ RepresentationTheory.Quiver.FinFourLinearData.finFourQuiverA
