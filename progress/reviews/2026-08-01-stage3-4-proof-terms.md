...
- Declarations inspected: 33051
- Import-DAG edges: 521
- Mapped proof/type edges beyond the old import DAG: 209
- Old import edges not recovered through owned-module proof/type mapping (trimmed): 132
- Mapped proof/type relation edges: 598
- Cyclic item components in that relation: 6
- Explicitly recorded cycle edges excluded from the DAG: 8
- Shipped acyclic proof-term edges: 590
- Current sources outside the root import: 49
