...
namespace IntroductionToRepresentationTheoryVerso.Content.Chapter5.DiscussionAfterTheorem543

#doc (Manual) "Historical note on Burnside's theorem and proof plan" =>

# Historical note on Burnside's theorem and proof plan
%%%
tag := "Chapter5/Discussion_after_Theorem5.4.3"
number := false
%%%
