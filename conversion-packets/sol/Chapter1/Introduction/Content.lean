...
namespace IntroductionToRepresentationTheoryVerso.Content.Chapter1.Introduction

#doc (Manual) "Chapter 1: Introduction" =>
# Chapter 1: Introduction
%%%
tag := "Chapter1/Introduction"
number := false
%%%

## Chapter 1: Introduction
%%%
tag := "Chapter1/Introduction/heading-1"
number := false
%%%
...
The goal of this book is to give a “holistic” introduction to representation theory, presenting it as a unified subject which studies representations of associative algebras and treating the representation theories of groups, Lie algebras, and quivers as special cases. It is designed as a textbook for advanced undergraduate and beginning graduate students and should be accessible to students with a strong background in linear algebra and a basic knowledge of abstract algebra. Theoretical material in this book is supplemented by many problems and exercises which touch upon a lot of additional topics; the more difficult exercises are provided with hints.
